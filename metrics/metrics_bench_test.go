...
// BenchmarkInitBasic benchmarks the basic initialization of the metrics provider with minimal configuration.
func BenchmarkInitBasic(b *testing.B) {
	...
	os.Setenv("OTEL_EXPORTER_OTLP_METRICS_PROTOCOL", "http") // Use HTTP to avoid gRPC overhead in benchmark
